...
* A new stable version is released every year about March or April and development
  versions are updated on a daily basis. The last major release (version 4.1.0) took
  place on April, 2021.
...
* Levels are alphabetically ordered by default, but that order can be modified
  using the `level` argument in the call to `factor()`:
  <pre>
...
.pull-left[
![](img/redmonklangrankQ321.png)
.footnote[
[RedMonk programming language rankings](https://redmonk.com/sogrady/2021/08/05/language-rankings-6-21)
]
]
.pull-right[
![](img/rochecompbiojob.jpg)
.footnote[
[Roche Job offer for a computational biologist (10/2021)](https://www.roche.com/careers/jobs/jobsearch/job.htm?id=E-202105-113413&locale=en&title=Computational+Biologist)
]
]
