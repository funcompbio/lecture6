...
<!-- NOTE: range different from python (half open), in R both numbers are part of interval -->
<!-- TODO: Vectors always contain same type of data types, maybe change a little bit these slides -->
...
<!-- TODO: Clarify access of matrix/data.frame elements where [r,c] -->
